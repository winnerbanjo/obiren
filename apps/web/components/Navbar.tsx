        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="md:hidden flex items-center gap-2">
              <button
                onClick={onOpenSignIn}
                className="px-3 py-1.5 bg-white border border-[#E7E2EB] text-[#17131D] text-xs font-bold rounded-full"
              >
                Sign In
              </button>
              <button
                onClick={onOpenSignUp}
                className="px-3.5 py-1.5 bg-[#6C4CF1] text-white text-xs font-bold rounded-full"
              >
                Sign Up
              </button>
              <button
