export type UserRole = "USER" | "TRUSTED_CONTACT" | "HEALTHCARE_PROFESSIONAL" | "SUPPORT_AGENT" | "CONTENT_MANAGER" | "MEDICAL_REVIEWER" | "EMERGENCY_MANAGER" | "ADMIN" | "SUPER_ADMIN";
...
export interface EmergencyResource {
    id: string;
    name: string;
    category: "HOSPITAL" | "AMBULANCE" | "POLICE" | "FIRE" | "WOMENS_SHELTER" | "DOMESTIC_VIOLENCE" | "SEXUAL_ASSAULT" | "MENTAL_HEALTH" | "PHARMACY";
    countryCode: CountryCode;
    state: string;
    city: string;
    address: string;
...
export interface HealthDocument {
    id: string;
    userId: string;
    category: "PRESCRIPTION" | "LAB_RESULT" | "ULTRASOUND" | "VACCINATION" | "MEDICAL_LETTER" | "INSURANCE" | "OTHER";
    title: string;
